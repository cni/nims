...
jQuery(document).ready(function() {
  ...
  if ('id' in argsParsed && 'filename' in argsParsed) {
    //https://cni.stanford.edu/nims/file?id=249488&filename=6531_16_1.nii.gz
    loadFile('https://cni.stanford.edu/nims/file?id='+argsParsed['id']+'&filename='+argsParsed['filename']);
